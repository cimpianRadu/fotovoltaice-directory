...
// Testimoniale de la clienți care au semnat cu o firmă găsită aici. Vin din tabul
// „Feedback clienți” (formularul /feedback/client) și intră în
// data/testimoniale.json DOAR cu „da” în coloana K; la „da-fara-nume” numele
// se scoate. Textul se copiază exact cum l-a scris omul, fără corecturi.
//
// Firma cu care a semnat NU se numește: acordul e al clientului, nu al firmei.
      ...
      <figure className="mt-5 rounded-2xl border border-border bg-white p-6 sm:p-8 shadow-sm">
        ...
        <figcaption className="mt-5 flex flex-wrap items-center gap-x-3 gap-y-1 text-sm">
          ...
          <span className="text-gray-500">
            {[t.tip, `${t.putere} kW`, t.judet].join(' · ')}
          </span>
