        ...
        <div className="sm:grid sm:grid-cols-2 lg:grid-cols-4 sm:gap-8">
          <FooterAccordion title="Pagini">
            <ul className="space-y-2">
              ...
              <li><Link href="/calculator-panouri-fotovoltaice" className={linkClass}>Calculator panouri fotovoltaice</Link></li>
              <li><Link href="/calculator-casa-verde-baterii" className={linkClass}>Calculator Casa Verde Baterii</Link></li>
              ...
              <li><Link href="/cere-oferta?sursa=footer" className={linkClass}>Cere oferte</Link></li>
