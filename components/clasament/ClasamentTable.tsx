  ...
  return (
    <div>
      ...
      <div className="flex items-start gap-2 mb-3 px-1 text-xs text-gray-500">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4 flex-shrink-0 mt-0.5 text-gray-400" aria-hidden="true">
          <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a.75.75 0 000 1.5h.253a.25.25 0 01.244.304l-.459 2.066A1.75 1.75 0 0010.747 15H11a.75.75 0 000-1.5h-.253a.25.25 0 01-.244-.304l.459-2.066A1.75 1.75 0 009.253 9H9z" clipRule="evenodd" />
        </svg>
        <span className="leading-relaxed">
          Majoritatea cifrelor financiare sunt pentru anul fiscal <strong>2024</strong> — ultimul bilanț complet depus public la Ministerul Finanțelor.
          Bilanțurile pentru 2025 se depun până pe 30 mai 2026 și vor fi disponibile în lunile următoare. Câteva firme care au depus deja apar cu date 2025.
        </span>
      </div>
