...
- **Status:** ✅ **re-cut a doua oară 2026-08-06** (primul re-cut 3 aug pe hook-ul B), programat joi 6 aug — `social/2026-08-03-alerta-energetica-stocare/`
- Reel narat **37s** (compoziția `Alerta`, 7 scene). Pe 6 aug userul a respins vocea și scriptul („AI smell, cel puțin începutul"): script rescris în registrul reelurilor acceptate (propoziții complete, fără punchlines telegrafice, fără teaser „uite ce nu știe multă lume"), voce Charon regenerată integral, cifre CTA actualizate la 184 firme / 35 județe. Faptele și structura pe scene, neschimbate. Decizia userului: reels narate, hook B, obiectiv **keywords + atenție + trafic spre site**, nu followers.
...
### #22 — Cereri cu poze / cereri îmbunătățite (reel narat, anunț produs)
- **Status:** ✅ **POSTAT 5 aug pe Facebook + Instagram** (marcat în Sheet pe 6 aug, folder redenumit cu ✅; nedistribuit încă pe YouTube Shorts și TikTok) — `social/2026-08-04-cereri-cu-poze ✅/` (`reel-voce.mp4`, 37s)
- Reel narat (compoziția `CereriPoze`, rețeta validată), refăcut din formatul inițial poză + caption la cererea userului. Scene: citat firme („dăm preț corect doar dacă vedem acoperișul și tabloul") → checklist 8 câmpuri (tip acoperiș, suprafață, putere, branșament, localitate, baterie, stație de încărcare, termen) → screenshot card Sibiu cu badge „Cu poze" (prod, 5 aug, anonimizat prin construcție) → „vă sunăm noi" tăiat / ofertă concretă → CTA.
- **Anunțul din spate:** commit `45b5dc8` (4 aug), câmpuri noi obligatorii + coloana Poze (AD) cu badge pe /cereri. Badge-ul apare la orice valoare non-goală în AD, deja live pe cardul Sibiu.
- **CTA:** /cere-oferta, UTM `utm_campaign=cereri-poze`; bio IG/TT direct pe /cere-oferta (vocea promite „lasă o cerere pe site"). Texte per platformă în folder.
...
### (fost #22, ABSORBIT în #20) — Alertă energetică: panourile on-grid nu vă țin casa la pană de curent (poster)
- **Status:** ❌ renunțat, absorbit în reelul #20 (decizia userului, 3 aug: doar reels narate). Folderul `social/2026-08-03-alerta-energetica/` rămâne pentru `surse.md`. ID-ul 22 din Sheet aparține acum reelului „cereri cu poze".
